 ...
 <tr>
          ...
          <tr>
            <td width="480" valign="top" style="padding-top:7px;"><table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="460" height="600" valign="top" background="/images/casino-box-bg-gamblingtemplatesdotnet-reg1.jpg" style="background-repeat:no-repeat;"><table width="380" border="0" cellpadding="0" cellspacing="0">
                  <tr>
    ...
    <br><INPUT name=r_antispam size=25 type=text value="" onfocus="if(this.value=='Введите слово с картинки'){this.value=''};" onblur="if(this.value==''){this.value='Введите слово с картинки'};"> <a href="#" class="navbar" onclick="document.getElementById('image').src = '/securimage/securimage_show.php?sid=' + Math.random(); return false">Поменять картинку</a>
...
<table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="460" height="275" valign="top" background="/images/casino-box-bg-gamblingtemplatesdotnet-reg.jpg" style="background-repeat:no-repeat;"><table width="380" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="380" valign="top" class="head-2"><div style="padding-top:13px;padding-left:15px;">Вы зарегистрированы в интернет казино <? echo $con[4]; ?></div></td>
                  </tr>
                  <tr>
