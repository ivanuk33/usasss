...
<!-- T0DO <script src="//ulogin.ru/js/ulogin.js"></script>
    ...
    <a class="btn btn-blue btn-md" href="lobby/login.php">
        <span>Вход</span>
    </a>
...
<font color="white ">Востановление пароля в интернет казино admiralslot.pro
<font class="content">
<font color="black"><form name="form" method="post" action="?st=lostpass" onSubmit="return formCheck(this)">


<font color="white ">Отправка логина и пароля на e-mail, указаный при регистрации<br><br>

Введите ваш E-mail: </td>
<td><input name="zapros" value="" type="text" size="20" maxlength="50" style="color:rgb(153,153,153); background-color:rgb(102,102,102);"></td>
<td><input type="hidden" name="send" value="1"><br><br>
<input type="submit" name="submit" class="btn btn-green btn-lg" value="Прислать пароль"></td>
